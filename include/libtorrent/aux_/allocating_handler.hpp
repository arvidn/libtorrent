...
namespace libtorrent::aux {
	...
	constexpr std::size_t udp_handler_max_size = tracking + debug_tick + 144 + 17 * sizeof(void*);
	constexpr std::size_t utp_handler_max_size = tracking + debug_tick + 168 + 17 * sizeof(void*);
