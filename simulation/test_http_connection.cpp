...
void test_connection_ssl_proxy(ssl_proxy_flags_t const flags)
{
	...
	std::string const expected_target =
		expect_hostname ? "test-hostname.com:8080" : "10.0.0.2:8080";
...
TORRENT_TEST(http_connection_ssl_proxy_no_hostname) { test_connection_ssl_proxy({}); }
