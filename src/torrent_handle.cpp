...
// ============ end deprecation ===============
    ...
    {
		TORRENT_ASSERT_PRECOND(start_piece >= piece_index_t(0) && (end_piece == piece_index_t(-1) || end_piece >= start_piece));
		if (start_piece >= piece_index_t(0) && (end_piece == piece_index_t(-1) || end_piece >= start_piece))
