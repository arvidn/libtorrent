...
class session(metaclass=_BoostBaseClass):
    ...
    def add_torrent(
        ...
        """
        add_torrent( (session)arg1, (torrent_info)ti, (str)save [, (object)resume_data=None [, (storage_mode_t)storage_mode=libtorrent.storage_mode_t.storage_mode_sparse [, (bool)paused=False]]]) -> torrent_handle :
        """
    ...
    @overload
    def find_torrent(self, _info_hash: sha256_hash) -> torrent_handle:
        """
        find_torrent( (session)arg1, (sha256_hash)arg2) -> torrent_handle :
        """
