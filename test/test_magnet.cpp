...
TORRENT_TEST(parse_invalid_hex_hash)
{
	...
	add_torrent_params p =
		parse_magnet_uri("magnet:?xt=urn:btih:zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz", ec);
	TEST_EQUAL(ec, error_code(errors::invalid_info_hash));
}
...
TORRENT_TEST(parse_v2_invalid_hex_hash)
{
	...
	add_torrent_params p = parse_magnet_uri(
		"magnet:?xt=urn:btmh:1220zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz",
		ec
	);
	TEST_EQUAL(ec, error_code(errors::invalid_info_hash));
}
