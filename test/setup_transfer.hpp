...
// path where web_server.py records the stopped announces it receives, for
// the most recently started web server (start_web_server() must have been
// called first).
EXPORT std::string web_server_stopped_announces_path();
